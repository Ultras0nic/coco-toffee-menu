...
-- Every product moves to the new per-unit rate; 4-packs and 6-packs keep a 5%
-- discount and dozens a 7% discount against that rate. Tiramisu, Portuguese
-- flan, chocoflan and the New York-style cheesecake leave the custom-quote
-- workflow and are now sold at fixed per-slice and whole-dessert prices.
...
insert into public.offers(id, product_id, offer_key, label, quantity_units, amount_cents, sort_order) values
  ...
  ('white-chocolate-macadamia:6-pack', 'white-chocolate-macadamia', '6-pack', '6-pack', 6, 2125, 20),
  ('white-chocolate-macadamia:dozen', 'white-chocolate-macadamia', 'dozen', 'Dozen', 12, 4175, 30),
  ...
  ('classic-fudge-brownie:4-pack', 'classic-fudge-brownie', '4-pack', '4-pack', 4, 1150, 20),
  ('classic-fudge-brownie:dozen', 'classic-fudge-brownie', 'dozen', 'Dozen', 12, 3350, 30),
  ('funfetti-blondie:single', 'funfetti-blondie', 'single', 'Each', 1, 300, 10),
  ('funfetti-blondie:4-pack', 'funfetti-blondie', '4-pack', '4-pack', 4, 1150, 20),
  ('funfetti-blondie:dozen', 'funfetti-blondie', 'dozen', 'Dozen', 12, 3350, 30),
  ...
  ('jumbo-cinnamon-roll:6-pack', 'jumbo-cinnamon-roll', '6-pack', '6-pack', 6, 2575, 20),
  ('bacon-gruyere-onion-quiche:single', 'bacon-gruyere-onion-quiche', 'single', 'Each', 1, 400, 10),
  ('bacon-gruyere-onion-quiche:6-pack', 'bacon-gruyere-onion-quiche', '6-pack', '6-pack', 6, 2275, 20),
  ('bacon-gruyere-onion-quiche:dozen', 'bacon-gruyere-onion-quiche', 'dozen', 'Dozen', 12, 4475, 30),
  ...
  ('pasteis-de-nata:6-pack', 'pasteis-de-nata', '6-pack', '6-pack', 6, 1000, 20),
  ('pasteis-de-nata:dozen', 'pasteis-de-nata', 'dozen', 'Dozen', 12, 1950, 30)
...
-- The four desserts above no longer take custom-quote requests, so retire the
-- quote offers a previously seeded database still has marked active.
